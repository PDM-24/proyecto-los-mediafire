...
@Composable
fun CrearPerfil(navController: NavController,userCreateViewModel: userCreateViewModel) {

    var username by remember { mutableStateOf("") }
    var year_nac by remember { mutableStateOf("") }
    Column(
        modifier = Modifier
            .fillMaxSize()
            .background(black),
                ...
                confirmButton = {
                    TextButton(
                        onClick = {
                            ...
                            year_nac=date
                            println("Fecha seleccionada: $date") // Imprime la fecha seleccionada
                        },
        ...
        Button(
            onClick = {
                userCreateViewModel.username.value = username
                userCreateViewModel.year_nac.value = year_nac
                navController.navigate(AppScreens.Genero.route)
...
fun CrearPerfilPreview() {
    ...
    CrearPerfil(navController,userCreateViewModel)
}